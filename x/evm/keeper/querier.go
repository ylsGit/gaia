...
func NewQuerier(k Keeper, legacyQuerierCdc *codec.LegacyAmino) sdk.Querier {
	return func(ctx sdk.Context, path []string, _ abci.RequestQuery) ([]byte, error) {
		...
		case types.QueryContractDeploymentWhitelist:
			return queryContractDeploymentWhitelist(ctx, k, legacyQuerierCdc)
		case types.QueryContractBlockedList:
			return queryContractBlockedList(ctx, k, legacyQuerierCdc)
		default:
...
func queryContractBlockedList(ctx sdk.Context, k Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
	return nil, nil
	//blockedList := types.CreateEmptyCommitStateDB(k.GeneratePureCSDBParams(), ctx).GetContractBlockedList()
	//res, err := codec.MarshalJSONIndent(legacyQuerierCdc, blockedList)
	//if err != nil {
	//	return nil, sdkerrors.Wrap(sdkerrors.ErrJSONMarshal, err.Error())
	//}
	//
...
func queryContractDeploymentWhitelist(ctx sdk.Context, k Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
	return nil, nil
	//whitelist := types.CreateEmptyCommitStateDB(k.GeneratePureCSDBParams(), ctx).GetContractDeploymentWhitelist()
