...
var (
	...
	pattern_Query_Section_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "evm", "v1beta1", "section"}, "", runtime.AssumeColonVerbOpt(true)))
)
